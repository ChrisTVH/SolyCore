...
module.exports.launch = async (client) => {
    ...
    app
        ...
        .set("vistas", path.join(__dirname, "/views")) // Set the ejs templates to ./views
        .set("puerto", config.DASHBOARD.port) // Set the dashboard port
        .use(
            session({
    ...
    app.listen(app.get("port"), () => {
        client.logger.success("Dashboard está escuchando en el puerto " + app.get("port"));
    });
};