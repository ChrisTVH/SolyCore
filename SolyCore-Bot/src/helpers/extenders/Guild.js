...
/**
 * Obtener todos los canales que coinciden con la consulta
 * @param {string} query
...
/**
 * Buscar todas las funciones que coincidan con la consulta
 * @param {string} query
 */
...
Guild.prototype.resolveMember = async function (query, exact = false) {
  ...
  // Comprobar si se pasa el mencionado o el ID
