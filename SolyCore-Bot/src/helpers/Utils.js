...
module.exports = class Utils {
  ...
  /**
   * Comprueba si una cadena es una invitación a la discord válida
   * @param {string} text
   */
  ...
  /**
   * Devuelve un número aleatorio por debajo de un máximo
   * @param {number} max
   */
  ...
  /**
   * Comprueba si una cadena es un color Hex válido
   * @param {string} text
   */
  static isHex(text) {
  ...
  /**
   * Devuelve el tiempo restante en días, horas, minutos y segundos
  ...
  /**
   * Convierte la duración en milisegundos
